...
class GRPCTestServer(object):
    ...
    def SimpleMethod(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GRPCTestServer/SimpleMethod',
    ...
    def ClientStreamingMethod(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/GRPCTestServer/ClientStreamingMethod',
            test__server__pb2.Request.SerializeToString,
            test__server__pb2.Response.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ServerStreamingMethod(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/GRPCTestServer/ServerStreamingMethod',
            test__server__pb2.Request.SerializeToString,
            test__server__pb2.Response.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def BidirectionalStreamingMethod(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/GRPCTestServer/BidirectionalStreamingMethod',
            test__server__pb2.Request.SerializeToString,
            test__server__pb2.Response.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
